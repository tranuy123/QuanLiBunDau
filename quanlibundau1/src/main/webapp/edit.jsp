                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <a href="home"><h1>Home</h1></a>
                            <h2>Chỉnh sửa  <b>Menu</b></h2>
                            
                        </div>
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Thêm món mới </span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <c:forEach items="${listmonchinh}" var="o">
                            <tr>
                                ...
                                <td>${o.price} VNĐ</td>
                                <td>
                                    <a href="suacontrol?pid=${o.id }"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
